    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Reporting </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        <li><a href="all-booking.html"> Standard Reporting </a></li>
                        <li><a href="edit-booking.html"> Indicator Monitoring </a></li>
                        <li><a href="add-booking.html"> M & E Reporting </a></li>
                    </ul>
                </li>



                <li class="submenu" > <a href="#"><i class="fas fa-key"></i> <span> Planning </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        <li><a href="#"> Community Strategy Framework </a></li>
                        <li><a href="{{ route('planning/listwpa') }}"> Work Plans </a></li>
                        <li><a href="#"> My Submissions </a></li>
                        <li><a href="{{ url('planning/rv/wpa') }}"> My Reviews </a></li>
                ...
                <li class="submenu" > <a href="#"><i class="fas fa-user"></i> <span> Users </span> <span class="menu-arrow"></span></a>
                    <ul class="submenu_class" style="display: none;">
                        <li class="{{ Request::is('institution') ? 'active':''}}" ><a href="{{route('institution')}}"> Community </a></li>
                        <li><a href="{{route('admin.index')}}"> All Users </a></li>
                    </ul>
                </li>
                ...
                <li> <a href="activities.html"><i class="far fa-bell"></i> <span> Reminders </span></a> </li>
