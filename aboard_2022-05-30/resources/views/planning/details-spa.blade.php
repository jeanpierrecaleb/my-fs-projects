                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Activity details
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-7">
                                    <form class="ps-lg-4">
                                        <!-- Product title -->
                                        <h3 class="mt-0">{{ $spactivity->name }} <a
                                                href="{{ url('planning/outcome/edit/' . $spactivity->id) }} "
                                                class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a>
                                        </h3>
                                        <p class="mb-1">Added Date: {{ $spactivity->created_at }}</p>
                                        <p class="font-16">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <h3> {{ $spactivity->baseline_date }} </h3>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $spactivity->updated_at }} </p>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $spactivity->active }}</p>
                                                </div>
                                            </div>
                                        </div>
