                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Subprogram details - Output of {{ $subprogram->name }} / Activity
                            </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right"> Details Subprogram
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    {{-- <a href="{{ url('planning/add-indicators/' . $outcome->id) }}" class="btn btn-dark mb-2"><i
                                        ...
                                        <a class="btn btn-dark mb-2" href="{{ url('planning/spactivity/add/'.$subprogram->id ) }}"><i class="fa fa-plus"
                                            aria-hidden="true"></i> Add Activity</a>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($subprogram->spactivities as $activity)
                                            <tr>
                                                ...
                                                <td class="outcome_id">
                                                    {{ $activity->subprogram_id }}, {{ $activity->subprogram->name }}

                                                </td>
                                                <td class="status">
                                                    {{ $activity->subprogram->program->id }}, {{ $activity->subprogram->program->name }}
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- <a style="color: black"
                                                        href="{{ url('planning/spactivity/details/'.$subprogram->id.'/'.$activity->id )}}"><i
                                                            ...
                                                            <a style="color: black"
                                                        href="{{ url('planning/spactivity/details/'.$subprogram->id.'/'.$activity->id )}}"><i class="fas fa-angle-double-right"></i></a>
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    {{-- <a href="{{ url('planning/add-indicators/' . $outcome->id) }}" class="btn btn-dark mb-2"><i
                                        ...
                                        <a class="btn btn-dark mb-2" href="{{ url('planning/output/add/'.$subprogram->id ) }}"><i class="fa fa-plus"
                                            aria-hidden="true"></i> Add Output</a>
                                    <!-- <button type="button" class="btn btn-dark w-sm-100" data-bs-toggle="modal" data-bs-target="#createproject"><i class="icofont-plus-circle me-2 fs-6"></i>Create Project</button> -->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($subprogram->outputs as $output)
                                            <tr>
                                                ...
                                                <td class="outcome_id">
                                                    {{ $output->subprogram_id }}, {{ $output->subprogram->name }}
                                                ...
                                                <td>
                                                    ...
                                                    <a style="color: black"
                                                        href="{{ url('planning/output/edit/'. $output->id) }} "><i
                                                            class="fas fa-pencil-alt m-r-5"></i> </a>
                                                    <a style="color: black"
                                                        href="{{ url('planning/output/delete/'.$output->id) }}"
                                                        onclick="return confirm('Are you sure to delete it ?')"><i
                                                            class="fas fa-trash-alt m-r-5"></i></a>

                                                    <a style="color: black"
                                                        href="{{ url('planning/output/details/'.$subprogram->id.'/'.$output->id )}}"><i
                                                            class="fas fa-info m-r-5 "></i></a>
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-7">
                                    <form class="ps-lg-4">
                                        <!-- Product title -->
                                        <h3 class="mt-0">{{ $subprogram->name }} <a
                                                href="{{ url('planning/outcome/edit/' . $subprogram->id) }} "
                                                class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a>
                                        </h3>
                                        <p class="mb-1">Added Date: {{ $subprogram->created_at }}</p>
                                        <p class="font-16">
                                        ...
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $subprogram->updated_at }} </p>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $subprogram->active }}</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-body">
                        <form action="{{ url('planning/create-ocindicator')}}" method="POST" id="myform2">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" value="{{$outcome->id}}" id="outcome_id" name="outcome_id"
                                    placeholder="Say what is the name of the Outcome Id ">
                            </div>

                            <div class="mb-3">

                                <input type="hidden" class="form-control" value="{{$outcome->program_id}}" id="program_id" name="program_id"
                                    placeholder="Say what is the name of the Program Id ">
                            </div>
