...
@section('content')
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Details Output > Indicators of {{ $output->name }}
                            </li>
                                ...
                                <div class="col-sm-4">
                                    {{-- <a href="{{ url('planning/add-indicators/' . $outcome->id) }}" class="btn btn-dark mb-2"><i
                                        ...
                                        <a class="btn btn-dark mb-2" data-toggle="modal" data-target="#createproject"><i class="fa fa-plus"
                                            aria-hidden="true"></i> Add Indicator for Output</a>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($output->otpindicators as $otpindicator)
                                            <tr>
                                                <td class="id">
                                                ...
                                                <td class="outcome_id">
                                                    {{ $otpindicator->output_id }}, {{ $otpindicator->output->name }}
                                                ...
                                                <td>
                                                    ...
                                                    <a style="color: black"
                                                        href="{{ url('planning/otpindicator/edit/'. $otpindicator->id) }} "><i
                                                            class="fas fa-pencil-alt m-r-5"></i> </a>
                                                    <a style="color: black"
                                                        href="{{ url('planning/otpindicator/delete/'.$otpindicator->id) }}"
                                                        onclick="return confirm('Are you sure to delete it ?')"><i
                                                            class="fas fa-trash-alt m-r-5"></i></a>

                                                    <a style="color: black"
                                                        href="{{ url('planning/otpindicator/details/'.$output->id.'/'.$otpindicator->id )}}"><i
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-7">
                                    <form class="ps-lg-4">
                                        <!-- Product title -->
                                        <h3 class="mt-0">{{ $output->name }} <a
                                                href="{{ url('planning/output/edit/' . $output->id) }} "
                                                class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a>
                                        </h3>
                                        <p class="mb-1">Added Date: {{ $output->created_at }}</p>
                                        <p class="font-16">
                                        ...
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $output->updated_at }} </p>
                                                </div>
                                                <div class="col-md-4">
                                                    <h6 class="font-14">Last Updater</h6>
                                                    <p class="text-sm lh-150"> Utilisateur de id ... </p>
                                                </div>
                                                <div class="col-md-4">
                                                    <h6 class="font-14">Quater</h6>
                                                    <p class="text-sm lh-150">{{ $output->quater }}</p>
                                                </div>
                                            </div>
                                        </div>
    ...
    <!-- Create Modal Indicator for output -->
    <!-- <div class="modal fade" id="createproject" tabindex="-1" role="dialog" aria-hidden="true"> -->
        <div class="modal fade" id="createproject" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Create Output Indicator</h5>
                    ...
                    <div class="modal-body">
                        <form action="{{ url('planning/otpindicator/create')}}" method="POST" id="myform2">
                            {{ csrf_field() }}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" class="form-control" value="{{$output->id}}" id="output_id" name="output_id"
                                    placeholder="Say what is the name of the Output Id ">
                            </div>

                            <div class="mb-3">

                                <input type="hidden" class="form-control" value="{{$output->subprogram_id}}" id="subprogram_id" name="subprogram_id"
                                    placeholder="Say what is the name of the SubProgram Id ">
                            </div>
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col">
                                            ...
                                            <select class="form-select" id="sector" name="sector" form="myform2" >
                                                <option value="" disabled >Choisisser</option>
