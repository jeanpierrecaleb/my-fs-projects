...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Create Outcome for {{$program->name}} </li>
            ...
            <form action="{{ url('planning/create-outcome') }}" method="POST" id="myform">
                {{ csrf_field() }}
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="hidden" id="wpaid" class="form-control" name="wpaid"
                        placeholder="Wpaid" value="{{$program->wpa_id}}" >
                </div>
                ...
                <div class="mb-3">
                    <label for="description" class="form-label">Priority Area</label>
                    <textarea id="objective" name="objective" form="myform" class="form-control" rows="3"
                        placeholder="Add the priority area about the request" ></textarea>
                </div>
