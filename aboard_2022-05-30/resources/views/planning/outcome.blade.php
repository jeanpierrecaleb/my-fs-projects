                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Outcome </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <a href="planning/add-outcome" class="btn btn-dark mb-2"><i class="fa fa-plus" aria-hidden="true"></i> Add
                                        Outcome</a>
                                    ...
                                    <tbody>
                                        @foreach ($outcomes as $outcome)
                                                <tr>
                                                    ...
                                                    <td class="program_id">
                                                        {{$outcome->program->id}}, {{$outcome->program->name}}
