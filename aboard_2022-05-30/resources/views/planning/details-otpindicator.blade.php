                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Otpindicator details
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                ...
                                <div class="col-lg-7">
                                    <form class="ps-lg-4">
                                        <!-- Product title -->
                                        <h3 class="mt-0">{{ $otpindicator->name }} <a
                                                href="{{ url('planning/outcome/edit/' . $otpindicator->id) }} "
                                                class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a>
                                        </h3>
                                        <p class="mb-1">Added Date: {{ $otpindicator->created_at }}</p>
                                        <p class="font-16">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <h3> {{ $otpindicator->baseline_date }} </h3>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $otpindicator->updated_at }} </p>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <h6 class="font-14">Active ? </h6>
                                                    <p class="text-sm lh-150">{{ $otpindicator->active }}</p>
                                                </div>
                                            </div>
                                        </div>
