                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Community > Institution details </li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-7">
                                    <form class="ps-lg-4">
                                        <!-- Product title -->
                                        <h3 class="mt-0">{{ $institution->name }} <a
                                                href="{{ url('institution/edit/'.$institution->id ) }} " class="text-muted"><i
                                                    class="mdi mdi-square-edit-outline ms-2"></i></a> </h3>
                                        <p class="mb-1">Added Date: {{$institution->created_at}}</p>
                                        <p class="font-16">
                                        ...
                                        <!-- Product description -->
                                        <div class="mt-4">
                                            <h6 class="font-14">Country of location</h6>
                                            <h3> {{ $institution->country }} </h3>
                                        </div>

                                        <!-- Quantity -->
                                        <div class="mt-4">
                                            <h6 class="font-14">Town</h6>
                                            <div class="d-flex">
                                                <p>{{ $institution->town }} </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <p class="text-sm lh-150">{{ $institution->updated_at }} </p>
                                                </div>
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <h6 class="font-14">Meta_descrip</h6>
                                                    <p class="text-sm lh-150">{{ $institution->meta_descrip }}</p>
                                                </div>
                                            </div>
                                        </div>
