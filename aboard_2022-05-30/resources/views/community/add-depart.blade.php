...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Community > Create Department </li>
            ...
            <form action="{{ url('create-depart') }}" method="POST" id="myform">
                {{ csrf_field() }}
                <div class="mb-3">
                    <label for="name" class="form-label">Department Name</label>
                    <input type="text" id="name" class="form-control" name="name"
                        placeholder="Select the belonging institution" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Belonging institution</label>
                    <select id="institution_id" name="institution_id" class="form-select" aria-label="Select the institution" required>
