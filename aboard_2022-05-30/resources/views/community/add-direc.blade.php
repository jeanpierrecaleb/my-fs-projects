...
@section('content')
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Community > Create Directorate </li>
            ...
            <form action="{{ url('create-direc') }}" method="POST" id="myform">
                {{ csrf_field() }}
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select id="department_id" name="department_id" class="form-select" aria-label="Select a Department" required>
                ...
                <div class="deadline-form">
                    <form>
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col">
                                <label for="town" class="form-label">City of location</label>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="address" name="address" form="myform" class="form-control"
