                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Community > List of Departments </li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    <a href="add-depart" class="btn btn-dark mb-2">+ Add
                                        Department</a>
                                        ...
                                        @foreach ( $departments as $item)
                                            <tr>
                                                ...
                                                <td class="table-action">
                                                    <a href="{{url('details-depart/'.$item->id) }}" class="action-icon"> <i
                                                            class="mdi mdi-eye"></i></a>
                                                    <a class="action-icon" href="{{ url('department/edit/'.$item->id ) }} "> <i
                                                            class="mdi mdi-square-edit-outline"></i></a>
                                                    <!-- data-bs-toggle="modal" data-bs-target="#editinstitution" data-idUpdate="'$value->id'" -->
                                                    <a href="{{ url('del-depart/'.$item->id) }}" onclick="return confirm('Are you sure to delete it ?')" class="action-icon"> <i
                                        ...
                                        @foreach ($departments as $depart)
                                                <tr>
                                                    ...
                                                    <td class="institution_id">
                                                        {{ $depart->institution_id }}, {{ $depart->institution->name }}
                                                    ...
                                                    <td>
                                                        ...
                                                        <a style="color: black" href="{{ url('department/edit/'.$depart->id ) }} "><i class="fas fa-pencil-alt m-r-5"></i> </a>
                                                        <a style="color: black" href="{{ url('del-depart/'.$depart->id) }}" onclick="return confirm('Are you sure to delete it ?')"><i class="fas fa-trash-alt m-r-5"></i></a>
                                                        <a style="color: black" href="{{url('details-depart/'.$depart->id) }}"><i class="fas fa-info m-r-5 "></i></a>
