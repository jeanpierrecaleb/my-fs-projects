                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"> Planning > Reviewing > Annual Work Plan  </li>
             ...
             <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">Review the Annual Work Plan
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        @foreach ($wpas as $wpa)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a style="color: black" href="{{ url('planning/rv/wpa/edit/'.$wpa->id ) }} "><i class="fas fa-pencil-alt m-r-5"></i> </a>
                                                        <a style="color: black" href="{{ url('planning/rv/del-wpa/'.$wpa->id ) }}" onclick="return confirm('Are you sure to delete it ?')"><i class="fas fa-trash-alt m-r-5"></i></a>
                                                        {{-- <a style="color: black" href="{{url('planning/details-wpa/'.$wpa->id) }}"><i class="fas fa-info m-r-5 "></i></a> --}}
                                                        {{-- <a style="color: black" href="{{url('planning/rv/details-wpa/'.$wpa->id) }}"><i class="fas fa-plus"></i></i></a> --}}
